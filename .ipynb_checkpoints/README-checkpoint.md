This project is a work in progress. Using a variety of publicly available data about tens of thousands of feature films, the end goal is to design a machine learning algorithm that can predict:
